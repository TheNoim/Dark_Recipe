...
class ViewController: UIViewController, DrawerToggleViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        progressView.updateProgressState(with: ProgressState(text: "Jailbreaking…", image: nil, spinnerState: .none, overrideRingColour: nil), animated: false)
    ...
    func doJailbreak() {
        if !hasStarted {
            ...
            progressView.updateProgressState(with: ProgressState(text: "Jailbreaking…", image: nil, spinnerState: .spinning, overrideRingColour: nil), animated: true)
